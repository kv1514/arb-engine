...
8. ~~NCAAF~~ — done 2026-09-18: `data/ncaaf_teams.json` (761 programs from ESPN + venue codes,
   ...
   (`cfb`) and Robinhood's CDNA-routed college games. Still open: NBA/NHL tables the same way
   (`KXNBAGAME`/`KXNHLGAME`, Robinhood `nba`/`nhl`), Polymarket college spreads/totals.
